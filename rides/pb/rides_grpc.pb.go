...
func (c *ridesClient) Start(ctx context.Context, in *StartRequest, opts ...grpc.CallOption) (*StartResponse, error) {
	...
	err := c.cc.Invoke(ctx, Rides_Start_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ridesClient) End(ctx context.Context, in *EndRequest, opts ...grpc.CallOption) (*EndResponse, error) {
	out := new(EndResponse)
	err := c.cc.Invoke(ctx, Rides_End_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ridesClient) Location(ctx context.Context, opts ...grpc.CallOption) (Rides_LocationClient, error) {
	stream, err := c.cc.NewStream(ctx, &Rides_ServiceDesc.Streams[0], Rides_Location_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
